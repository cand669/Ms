...
public final class ItemPageBinding implements ViewBinding {
  ...
  @NonNull
  public final Button lld;

  private ItemPageBinding(@NonNull LinearLayout rootView, @NonNull Button lld) {
  ...
  public static ItemPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.lld;
      Button lld = rootView.findViewById(id);
      if (lld == null) {
        break missingId;
      }

      return new ItemPageBinding((LinearLayout) rootView, lld);
    }
